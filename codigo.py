...
firebase = firebase.FirebaseApplication('https://tela-de-login-3dd15-default-rtdb.firebaseio.com/',None)

#importing data
data= {
    'Email', 'barlindo314@gmail.com',
    'Password': 'arlindo1234@'
}

# Post Data
# Database name/ Table Name
firebase.post('https://tela-de-login-3dd15-default-rtdb.firebaseio.com/users', data)
